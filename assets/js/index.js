...
const homePageSection = [
  ...
  const genreList = {
    //creates genre string from genre_id eg: [23,44] to "Action, Romance".
    assString(genreIdList) {
      let newGenreList = [];
  ...
  fetchDataFromServer(
    ...
    function ({ genres }) {
      ...
      fetchDataFromServer(`https://api.themoviedb.org/3/movie/popular?language=en-US&api_key=${api_key}&page=1`, heroBanner)
    });
    ...
    for (const [index, movie] of movieList.entries()){
     ...
     <div class="banner-content">
       ...
       <h2 class="heading">${title}</h2>
        ...
        <p class="genre">${genreList.assString(genre_ids)}</p>
